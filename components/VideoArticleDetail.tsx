          ...
          <div className="max-w-6xl mx-auto">
            <div className="relative aspect-video bg-black rounded-lg overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.5)] border border-white/5">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <button className="bg-red-600 text-white rounded-full p-6 shadow-2xl hover:scale-110 transition-transform group">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black to-transparent flex items-center gap-4">
                 ...
                 <div className="flex-grow h-1 bg-white/20 rounded-full relative">
                    <div className="absolute top-0 left-0 h-full w-1/3 bg-red-600 rounded-full"></div>
                 </div>
        ...
        <div className="container mx-auto px-4 lg:px-8 max-w-6xl">
          <div className="flex flex-col md:flex-row md:items-start gap-12 lg:gap-16">
            ...
            <div className="flex-grow">
              <div className="mb-6">
                <span className="bg-red-600 text-white px-2 py-0.5 text-[10px] font-black uppercase tracking-widest rounded-sm">VIDEO REPORT</span>
              ...
              <div className="flex items-center gap-4 mb-10 pb-8 border-b border-gray-100 cursor-pointer group" onClick={handleAuthorClick}>
                ...
                <div>
                  <p className="text-[11px] font-black text-red-600 uppercase tracking-widest group-hover:text-red-700 transition-colors">
              ...
              <div className="mt-12 pt-8 border-t border-gray-100 flex items-center justify-between">
                <div className="flex gap-4">
                  <button className="flex items-center gap-2 px-4 py-2 bg-[#1a2a44] text-white text-[10px] font-bold uppercase rounded-sm hover:bg-red-600 transition">
            ...
            <aside className="w-full md:w-80 lg:w-96 flex-shrink-0">
                  ...
                  <div className="space-y-6">
                    {[1, 2, 3].map(i => (
                      <div key={i} className="group cursor-pointer">
                        ...
                        <h5 className="text-xs font-bold leading-tight group-hover:text-red-600 transition-colors">The Future of European Defense: Part {i + 1}</h5>
               ...
               <div className="bg-[#eb6761]/10 p-6 rounded-lg border border-[#eb6761]/20">
                  ...
                  <button className="w-full py-2 bg-red-600 text-white text-[10px] font-black uppercase rounded-sm">Subscribe</button>
               </div>
            </aside>
          </div>
        </div>
