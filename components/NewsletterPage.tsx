    ...
    <main className="flex-grow bg-white">
      ...
      <section className="bg-[#1a2a44] text-white py-20 lg:py-32 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
                <a href="#brussels-calling" className="px-8 py-4 bg-[#EE6260] text-white font-black text-xs uppercase tracking-widest rounded shadow-lg hover:bg-[#d44947] transition">BRUSSELS CALLING</a>
                ...
                <div className="w-full lg:w-1/2">
                    ...
                    <div className="bg-gray-50 p-8 rounded-xl border border-gray-200 mb-8">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            ...
                            <button className="px-8 py-3 bg-[#EE6260] text-white font-black text-xs uppercase tracking-widest rounded hover:bg-[#d44947] transition">SUBSCRIBE</button>
                        </div>
                    </div>

                    <div className="flex items-center gap-6">
                        <button className="text-xs font-black text-[#1a2a44] hover:text-[#EE6260] flex items-center gap-2 transition-colors">
      ...
      <section className="py-20 bg-[#1a2a44] text-white text-center">
         <div className="container mx-auto px-4 lg:px-8">
            ...
            <button className="px-10 py-5 bg-[#EE6260] text-white font-black text-sm uppercase tracking-widest rounded hover:bg-[#d44947] transition shadow-xl">
                GET THE SIGNALS
            </button>
         </div>
      </section>
