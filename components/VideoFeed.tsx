        ...
        <div className="relative group/section">
            <div className="flex justify-between items-center border-b-2 border-red-600 pb-2 mb-6">
                <h2 className="text-xl font-bold uppercase tracking-tight flex items-center gap-2">
                    <svg className="w-6 h-6 text-red-600 block" fill="currentColor" viewBox="0 0 24 24"><path d="M8 5v14l11-7z"/></svg>
                    Video Feed
                </h2>
                        ...
                        <div className="relative aspect-video overflow-hidden rounded-xl shadow-lg">
                            ...
                            <div className="absolute inset-0 bg-black/20 group-hover:bg-black/40 transition-colors flex items-center justify-center">
                                <div className="bg-white/90 rounded-full p-4 transform transition-transform group-hover:scale-110">
                                    <svg className="w-8 h-8 text-red-600 block" fill="currentColor" viewBox="0 0 24 24"><path d="M8 5v14l11-7z"/></svg>
                                </div>
                            </div>
                        </div>
                        <div className="mt-4">
                            <p className="text-[10px] text-gray-500 uppercase font-bold mb-1">
                                <span className="text-red-600">VIDEO</span> {vid.date} {vid.duration && `• ${vid.duration}`}
                            </p>
